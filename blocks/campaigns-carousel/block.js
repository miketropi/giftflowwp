                ...
                <div {...blockProps}>
                    {(a.eyebrow || a.heading || a.description) && (
                        <div style={{ textAlign: a.headerAlign || 'center', marginBottom: 32 }}>
                            ...
                            {a.description && <p style={{ margin: '0 auto', maxWidth: a.headerAlign === 'center' ? 560 : 'none', marginLeft: a.headerAlign === 'right' ? 'auto' : 0, marginRight: a.headerAlign === 'left' ? 'auto' : 0, fontSize: 15, lineHeight: 1.6, color: '#6b7280' }}>{a.description}</p>}
                        </div>
                    )}
