  ...
  <div class="giftflowwp-widget-content">
    <div class="giftflowwp-charts-container">
        <div class="giftflowwp-chart-item">
            <h3><?php _e('Donations', 'giftflowwp'); ?></h3>
        ...
        <div class="giftflowwp-chart-item giftflowwp-chart-item-campaigns">
            <h3><?php _e('Campaigns', 'giftflowwp'); ?></h3>
            <div class="giftflowwp-chart-container">
                    ...
                    plugins: {
                        legend: {
                            ...
                            labels: {
                                padding: 15,
                                usePointStyle: true,
                                font: { size: 11, lineHeight: 1, weight: 'normal' },
                                color: '#666',
                            }
                        },
                        tooltip: {
