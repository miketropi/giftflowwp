		...
		if ( $query->have_posts() ) {
			while ( $query->have_posts() ) {
				...
				$campaigns[] = array(
					...
					'goal_formatted'    => giftflow_render_currency_formatted_amount( $goal_amount, 2, null, '', false ),
					'raised_formatted'  => giftflow_render_currency_formatted_amount( $raised_amount, 2, null, '', false ),
